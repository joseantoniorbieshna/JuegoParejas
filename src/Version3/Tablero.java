...
public class Tablero {
	...
	public boolean revelarFichaEnPosicion(Coordenada cord) {
	...
	public boolean estaTotalmenteDesvelado() {
	...
	private void mezclarTablero() {
		...
		for (int i = 0; i < intercambios; i++) {
			Ficha fichaOrigen = getFichaInCoordenada(Coordenada.getAleatoriaConValoresMax(SIZE));
			Ficha fichaDestino = getFichaInCoordenada(Coordenada.getAleatoriaConValoresMax(SIZE));
